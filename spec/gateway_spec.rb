  ...
  describe "#get" do
    ...
    describe "when wiki returns 503" do
      ...
      before do
        ...
        @fail_gateway.stub(:log) { @log }
      end

      it "should retry twice and fail" do
        @log.should_receive(:warn).with("503 Service Unavailable: Maxlag exceeded.  Retry in 0 seconds.").twice
        lambda {
          @fail_gateway.get("")
        }.should raise_error
      end
  ...
  describe "#upload" do
    ...
    describe "when uploading a new file" do
      ...
      it "should open the file" do
        File.should_receive(:new).with("some/path/sample_image.jpg")
        @gateway.upload("some/path/sample_image.jpg")
